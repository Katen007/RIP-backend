...
-- Таблица users
-- =======================
INSERT INTO users (login, hashed_password, is_moderator)
VALUES
...
-- Таблица texts
-- =======================
INSERT INTO texts (is_delete, image_url, title, description, price)
VALUES
(false, 'http://localhost:9000/img/img/sci.jpg',
 'Научная статья',
 ...
 125),
(false, 'http://localhost:9000/img/img/his.jpg',
 ...
 400),
(false, 'http://localhost:9000/img/img/lit.jpg',
...
-- Таблица read_indxs
-- =======================
INSERT INTO read_indxs (status, date_create, creator_id, date_form, date_end, moderator_id, comments, contacts)
VALUES
('DRAFT', NOW(), 2, NOW(), NULL, 1,
