...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ReadIndxsModerateRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ReadIndxsModerateResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/texts": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "new text payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.TextCreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.TextUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/texts/{id}/image": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "raw binary image (Content-Type: image/*)",
                        "name": "file",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "handler.ReadIndxsModerateResponse": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
